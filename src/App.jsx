        ...
        <div className="container sky-content-container" style={{ position: 'relative', zIndex: 51, pointerEvents: 'none' }}>
          <section className="content-section">
            <Designable id="skyTitle" position={uiLayout.skyTitle} designMode={designMode} handleUIDrag={handleUIDrag}>
              <h2 className="big-headline animate-on-scroll" style={{ fontFamily: '"Caveat", cursive', fontWeight: 500, lineHeight: 1.1, color: '#f8fafc', textShadow: '0 4px 12px rgba(0,0,0,0.15)', letterSpacing: '1px' }}>For the world’s best talents to go<br />full-time on what they love.</h2>
            </Designable>
